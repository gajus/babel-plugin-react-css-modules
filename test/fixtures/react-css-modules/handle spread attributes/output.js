...
<div {..._objectWithoutProperties(rest, ["styleName", "className", "activeStyleName", "activeClassName"])} activeClassName={"b foo__a" + (" " + rest.activeClassName)}></div>; // Should be okay if rest is put on last
...
const rest2 = {};
<div {..._objectWithoutProperties(rest, ["styleName", "className", "activeStyleName", "activeClassName"])} {..._objectWithoutProperties(rest2, ["styleName", "className", "activeStyleName", "activeClassName"])} className={"foo__a" + (" " + (rest.className + (" " + rest2.className)))}></div>; // Should not do anything
